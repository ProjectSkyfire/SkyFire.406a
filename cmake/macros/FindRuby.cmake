...
IF (RUBY_EXECUTABLE)
    ...
    SET(RICE_LIBRARY "${RICE_DIR}/ruby/lib/lib/librice.a" CACHE PATH "Path to the Rice library file" FORCE)
    ...
    IF(RICE_VERSION AND GEM_DIR)
        ...
        SET(RUBY_INCLUDE_DIRS ${RUBY_INCLUDE_DIRS} ${RICE_INCLUDE_DIR} CACHE PATH "Include directories" FORCE)
        MESSAGE(STATUS "Include directories: " ${RUBY_INCLUDE_DIRS})
    ENDIF()
ENDIF()
