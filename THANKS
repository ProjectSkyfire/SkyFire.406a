...
by submitting bug reports, code patches, and suggestions. Thanks to the all the
...
Thanks go out to the following people for various patches/code from TrinityCore
...
Thanks go out to the following people for various patches/code from Project SkyFire
(listed in the order they were added):
AlterEgo, Aptiva(mobiledev), Arktus, LordJZ, Chameleon, Bloddy, Fabian, Sovak(Hacker007), 
Rad3k, Cerey(Venugh), AriDEV, TheHacker66, Dvlpr, Hammerstorm, Cristal, Keany(Woverine), 
Bloody, Cooler-SAI, Pepsi1x1, Danford, ZenitH, scruffy, Karen, DarkXuan, Ner'zhul, 
ChasterX, Kierkgaard, TehAvatar, Hav0c, Remake, cmaranec, Totomakers, MrBlitzKrieg,
Allnightlong, Snajl, NNN666, Portgas D.Ace, Fedr, Takenbacon, kaiser, DJScias, Starzu,
