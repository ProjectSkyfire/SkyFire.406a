...
int RASocket::check_access_level(const std::string& user)
{
    ...
    PreparedStatement* stmt = LoginDatabase.GetPreparedStatement(LOGIN_SELECT_ACCOUNT_ACCESS);
...
int RASocket::check_password(const std::string& user, const std::string& pass)
{
    ...
    PreparedStatement* stmt = LoginDatabase.GetPreparedStatement(LOGIN_SELECT_CHECK_PASSWORD_BY_NAME);
