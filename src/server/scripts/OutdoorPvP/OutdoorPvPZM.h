...
{
    LANGUAGE_OPVP_ZM_CAPTURE_EAST_A,
    LANGUAGE_OPVP_ZM_CAPTURE_WEST_A
};

const uint32 ZMBeaconCaptureH[ZM_NUM_BEACONS] =
{
    LANGUAGE_OPVP_ZM_CAPTURE_EAST_H,
    LANGUAGE_OPVP_ZM_CAPTURE_WEST_H
};

const uint32 ZMBeaconLoseA[ZM_NUM_BEACONS] =
{
    LANGUAGE_OPVP_ZM_LOSE_EAST_A,
    LANGUAGE_OPVP_ZM_LOSE_WEST_A
};

const uint32 ZMBeaconLoseH[ZM_NUM_BEACONS] =
{
    LANGUAGE_OPVP_ZM_LOSE_EAST_H,
    LANGUAGE_OPVP_ZM_LOSE_WEST_H
};
