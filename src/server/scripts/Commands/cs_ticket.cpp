...
public:
    ...
    static bool HandleGMTicketAssignToCommand(ChatHandler* handler, char const* args)
    {
        ...
        {
            handler->SendSysMessage(LANGUAGE_COMMAND_TICKETASSIGNERROR_A);
            return true;
        }
        ...
        {
            handler->PSendSysMessage(LANGUAGE_COMMAND_TICKETASSIGNERROR_B, ticket->GetId());
            return true;
        }
        ...
        {
            handler->PSendSysMessage(LANGUAGE_COMMAND_TICKETALREADYASSIGNED, ticket->GetId(), target.c_str());
            return true;
        }
    ...
    static bool HandleGMTicketCloseByIdCommand(ChatHandler* handler, char const* args)
    {
        ...
        if (player && ticket->IsAssignedNotTo(player->GetGUID()))
        {
            handler->PSendSysMessage(LANGUAGE_COMMAND_TICKETCANNOTCLOSE, ticket->GetId());
            return true;
        }
    ...
    static bool HandleGMTicketCommentCommand(ChatHandler* handler, char const* args)
    {
        ...
        if (!ticket || ticket->IsClosed())
        {
            handler->PSendSysMessage(LANGUAGE_COMMAND_TICKETNOTEXIST);
            return true;
        }
        ...
        if (player && ticket->IsAssignedNotTo(player->GetGUID()))
        {
            handler->PSendSysMessage(LANGUAGE_COMMAND_TICKETALREADYASSIGNED, ticket->GetId());
            return true;
        }
        ...
        msg += handler->PGetParseString(LANGUAGE_COMMAND_TICKETLISTADDCOMMENT, player ? player->GetName() : "Console", comment);
        handler->SendGlobalGMSysMessage(msg.c_str());
    ...
    static bool HandleGMTicketDeleteByIdCommand(ChatHandler* handler, char const* args)
    {
        ...
        if (!ticket->IsClosed())
        {
            handler->SendSysMessage(LANGUAGE_COMMAND_TICKETCLOSEFIRST);
            return true;
        }
    ...
    static bool HandleGMTicketResetCommand(ChatHandler* handler, char const* /*args*/)
    {
        ...
        {
            handler->SendSysMessage(LANGUAGE_COMMAND_TICKETPENDING);
            return true;
        }
        else
        {
            sTicketMgr->ResetTickets();
            handler->SendSysMessage(LANGUAGE_COMMAND_TICKETRESET);
        }
    ...
    static bool HandleToggleGMTicketSystem(ChatHandler* handler, char const* /*args*/)
    {
        ...
        handler->PSendSysMessage(status ? LANGUAGE_ALLOW_TICKETS : LANGUAGE_DISALLOW_TICKETS);
        return true;
    }
    ...
    static bool HandleGMTicketUnAssignCommand(ChatHandler* handler, char const* args)
    {
        ...
        {
            handler->PSendSysMessage(LANGUAGE_COMMAND_TICKETNOTASSIGNED, ticket->GetId());
            return true;
        }
        ...
        {
            handler->SendSysMessage(LANGUAGE_COMMAND_TICKETUNASSIGNSECURITY);
            return true;
        }
    ...
    static bool HandleGMTicketGetByNameCommand(ChatHandler* handler, char const* args)
    {
        ...
        if (!guid)
        {
            handler->SendSysMessage(LANGUAGE_NO_PLAYERS_FOUND);
            return true;
        }
