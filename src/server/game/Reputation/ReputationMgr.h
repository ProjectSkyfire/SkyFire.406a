...
{
    LANGUAGE_REP_HATED,    LANGUAGE_REP_HOSTILE, LANGUAGE_REP_UNFRIENDLY, LANGUAGE_REP_NEUTRAL,
    LANGUAGE_REP_FRIENDLY, LANGUAGE_REP_HONORED, LANGUAGE_REP_REVERED,    LANGUAGE_REP_EXALTED
};
