...
enum SpellAttr0
{
    ...
    SPELL_ATTR0_NEGATIVE_1                              = 0x04000000, // 26 Many negative spells have this attribute
...
enum Language
{
    LANGUAGE_UNIVERSAL                                  = 0,
    LANGUAGE_ORCISH                                     = 1,
    LANGUAGE_DARNASSIAN                                 = 2,
    LANGUAGE_TAURAHE                                    = 3,
    LANGUAGE_DWARVISH                                   = 6,
    LANGUAGE_COMMON                                     = 7,
    LANGUAGE_DEMONIC                                    = 8,
    LANGUAGE_TITAN                                      = 9,
    LANGUAGE_THALASSIAN                                 = 10,
    LANGUAGE_DRACONIC                                   = 11,
    LANGUAGE_KALIMAG                                    = 12,
    LANGUAGE_GNOMISH                                    = 13,
    LANGUAGE_TROLL                                      = 14,
    LANGUAGE_GUTTERSPEAK                                = 33,
    LANGUAGE_DRAENEI                                    = 35,
    LANGUAGE_ZOMBIE                                     = 36,
    LANGUAGE_GNOMISH_BINARY                             = 37,
    LANGUAGE_GOBLIN_BINARY                              = 38,
    LANGUAGE_WORGEN                                     = 39,
    LANGUAGE_GOBLIN                                     = 40,
    LANGUAGE_ADDON                                      = 0xFFFFFFFF    // used by addons, in 2.4.0 not exist, replaced by messagetype?
};
...
enum SpellEffects
{
    ...
    SPELL_EFFECT_MASS_RESURRECT                         = 172,  // Aoe resurrection
...
enum SpellCastResult // 4.0.6a 13623
{
...
enum HolidayIds
{
    ...
    HOLIDAY_CALL_TO_ARMS_AV                            = 283,                 // Call to Arms: Alterac Valley
    HOLIDAY_CALL_TO_ARMS_WS                            = 284,                 // Call to Arms: Warsong Gulch
    HOLIDAY_CALL_TO_ARMS_AB                            = 285,                 // Call to Arms: Arathi Basin
    HOLIDAY_FISHING_EXTRAVAGANZA                       = 301,                 // Weekly Event
    HOLIDAY_HARVEST_FESTIVAL                           = 321,
    HOLIDAY_HALLOWS_END                                = 324,
    HOLIDAY_LUNAR_FESTIVAL                             = 327,
    HOLIDAY_LOVE_IS_IN_THE_AIR                         = 335,
    HOLIDAY_FIRE_FESTIVAL                              = 341,
    HOLIDAY_CALL_TO_ARMS_EY                            = 353,                 // Call to Arms: Eye of the Storm
    HOLIDAY_BREWFEST                                   = 372,
    HOLIDAY_DARKMOON_FAIRE_ELWYNN                      = 374,
    HOLIDAY_DARKMOON_FAIRE_THUNDER                     = 375,
    HOLIDAY_DARKMOON_FAIRE_SHATTRATH                   = 376,
    HOLIDAY_PIRATES_DAY                                = 398,
    HOLIDAY_CALL_TO_ARMS_SA                            = 400,                 // Call to Arms: Strands of the Ancient
    HOLIDAY_PILGRIMS_BOUNTY                            = 404,
    HOLIDAY_WOTLK_LAUNCH                               = 406,                 // 3.0.1
...
enum ResponseCodes
{
    ...
    CHARACTER_DELETE_IN_PROGRESS                           = 0x46,
    CHARACTER_DELETE_SUCCESS                               = 0x47,
    CHARACTER_DELETE_FAILED                                = 0x48,
    CHARACTER_DELETE_FAILED_LOCKED_FOR_TRANSFER            = 0x49,
    CHARACTER_DELETE_FAILED_GUILD_LEADER                   = 0x4A,
    CHARACTER_DELETE_FAILED_ARENA_CAPTAIN                  = 0x4B,
...
enum BattlegroundTypeId
{
    ...
    BATTLEGROUND_RL                                        = 8,
    BATTLEGROUND_SA                                        = 9,                         // Strands of the Ancient
