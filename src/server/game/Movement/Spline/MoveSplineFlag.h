...
#pragma pack(push, 1)
    ...
    public:
        enum splineFlags
        {
            ...
            Enter_Cycle             = 0x00100000,           // Everytime appears with cyclic flag in monster move packet, erases first spline vertex after first cycle done
        ...
        void EnableTaxiFlight() { raw() = raw() | Catmullrom | Flying | Walkmode | UnCompressedPath; }
