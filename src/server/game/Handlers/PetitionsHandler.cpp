...
void WorldSession::HandlePetitionBuyOpcode(WorldPacket& recvData)
{
    ...
    // datacorruption
    PreparedStatement* stmt = CharacterDatabase.GetPreparedStatement(CHAR_SELECT_PETITION_BY_OWNER);
...
void WorldSession::HandlePetitionShowSignOpcode(WorldPacket& recvData)
{
    ...
    PreparedStatement* stmt = CharacterDatabase.GetPreparedStatement(CHAR_SELECT_PETITION_TYPE);
    ...
    stmt = CharacterDatabase.GetPreparedStatement(CHAR_SELECT_PETITION_SIGNATURE);
...
void WorldSession::SendPetitionQueryOpcode(uint64 petitionguid)
{
    ...
    PreparedStatement* stmt = CharacterDatabase.GetPreparedStatement(CHAR_SELECT_PETITION);
...
void WorldSession::HandlePetitionRenameOpcode(WorldPacket& recvData)
{
    ...
    stmt = CharacterDatabase.GetPreparedStatement(CHAR_UPDATE_PETITION_NAME);
...
void WorldSession::HandlePetitionSignOpcode(WorldPacket& recvData)
{
    ...
    PreparedStatement* stmt = CharacterDatabase.GetPreparedStatement(CHAR_SELECT_PETITION_SIGNATURES);
    ...
    stmt = CharacterDatabase.GetPreparedStatement(CHAR_SELECT_PETITION_SIG_BY_ACCOUNT);
    ...
    stmt = CharacterDatabase.GetPreparedStatement(CHAR_INSERT_PETITION_SIGNATURE);
...
void WorldSession::HandlePetitionDeclineOpcode(WorldPacket& recvData)
{
    ...
    PreparedStatement* stmt = CharacterDatabase.GetPreparedStatement(CHAR_SELECT_PETITION_OWNER_BY_GUID);
...
void WorldSession::HandleOfferPetitionOpcode(WorldPacket& recvData)
{
    ...
    stmt = CharacterDatabase.GetPreparedStatement(CHAR_SELECT_PETITION_SIGNATURES);
