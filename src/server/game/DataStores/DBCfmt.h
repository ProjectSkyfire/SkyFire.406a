...
const char FactionTemplateEntryfmt[]="niiiiiiiiiiiiiiiiiiffixsxx";
...
const std::string CustomSpellEntryIndex = "Id";    // these need redun properly for new spellsystem
