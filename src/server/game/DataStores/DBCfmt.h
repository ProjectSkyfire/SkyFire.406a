...
const char SpellEntryfmt[]="niiiiiiiiixiiiifiiiissxxiixxixiiiiiiixiiiiiiiixx";
const std::string CustomSpellEntryfmt="ppppppppppapppppppppaaaappaapapppppppappppppppaa";
...
const std::string CustomSpellTargetRestrictionsEntryfmt="pppppx";
