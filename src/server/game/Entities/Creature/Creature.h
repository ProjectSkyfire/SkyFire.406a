...
enum CreatureFlagsExtra
{
    ...
    CREATURE_FLAG_EXTRA_SUMMONER_ONLY   = 0x00200000,       // Creature can be seen by summoner only
...
#define CREATURE_FLAG_EXTRA_DB_ALLOWED (CREATURE_FLAG_EXTRA_INSTANCE_BIND | CREATURE_FLAG_EXTRA_CIVILIAN | \
    ...
    CREATURE_FLAG_EXTRA_GUARD | CREATURE_FLAG_EXTRA_SUMMONER_ONLY)
...
class Creature : public Unit, public GridObject<Creature>, public MapCreature
{
    public:
        ...
        bool isSummonerOnly() const { return GetCreatureTemplate()->flags_extra & CREATURE_FLAG_EXTRA_SUMMONER_ONLY; }
