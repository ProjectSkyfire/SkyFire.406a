...
bool PlayerSocial::AddToSocialList(uint32 friendGuid, bool ignore)
{
    ...
    {
        PreparedStatement* stmt = CharacterDatabase.GetPreparedStatement(CHAR_UPDATE_ADD_CHARACTER_SOCIAL_FLAGS);
    ...
    {
        PreparedStatement* stmt = CharacterDatabase.GetPreparedStatement(CHAR_INSERT_CHARACTER_SOCIAL);
...
void PlayerSocial::RemoveFromSocialList(uint32 friendGuid, bool ignore)
{
    ...
    {
        PreparedStatement* stmt = CharacterDatabase.GetPreparedStatement(CHAR_DELETE_CHARACTER_SOCIAL);
    ...
    {
        PreparedStatement* stmt = CharacterDatabase.GetPreparedStatement(CHAR_UPDATE_REM_CHARACTER_SOCIAL_FLAGS);
...
void PlayerSocial::SetFriendNote(uint32 friendGuid, std::string note)
{
    ...
    PreparedStatement* stmt = CharacterDatabase.GetPreparedStatement(CHAR_UPDATE_CHARACTER_SOCIAL_NOTE);
