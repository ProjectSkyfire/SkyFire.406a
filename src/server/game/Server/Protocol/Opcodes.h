...
enum Opcodes
{
    ...
    SMSG_HOTFIX_NOTIFY_BLOP                          = 0x04C1E, // 4.0.6a 13623
    SMSG_HOTFIX_NOTIFY                               = 0x04C0E, // 4.0.6a 13623
    CMSG_REQUEST_HOTFIX                              = 0x08589, // 4.0.6a 13623
    ...
    SMSG_PET_NAME_INVALID                            = 0x01457, // 4.0.6a 13623
    ...
    SMSG_RESURRECT_FAILED                            = 0x0D557, // 4.0.6a 13623
    ...
    SMSG_RAID_GROUP_ONLY                             = 0x00554, // 4.0.6a 13623
    ...
    CMSG_CHARACTER_RENAME                                 = 0x027C4, // 4.0.6a 13623
    SMSG_CHARACTER_RENAME                                 = 0x0E0EC, // 4.0.6a 13623
    ...
    CMSG_BATTLEMASTER_JOIN                           = 0x00137, // 4.0.6a 13623
    ...
    MSG_DELAY_GHOST_TELEPORT                         = 0x10127, // 4.0.6a 13623
    ...
    SMSG_SPELLSTEALLOG                               = 0x09F74, // 4.0.6a 13623
    ...
    SMSG_MOVE_SET_FLIGHT                             = 0x0C57F, // 4.0.6a 13623
    SMSG_MOVE_UNSET_FLIGHT                           = 0x0BDA0, // 4.0.6a 13623
    ...
    CMSG_SEARCH_LFG_LEAVE                            = 0x0847D, // 4.0.6a 13623
    ...
    CMSG_CANCEL_MOUNT_AURA                           = 0x064CC, // 4.0.6a 13623
    ...
    SMSG_RESET_FAILED_NOTIFY                         = 0x0BD5C, // 4.0.6a 13623
    ...
    CMSG_BOT_DETECTED                                = 0x0E757, // 4.0.6a 13623
    ...
    CMSG_CHANNEL_VOICE_ON                            = 0x05A98, // 4.0.6a 13623
    CMSG_CHANNEL_VOICE_OFF                           = 0x07A88, // 4.0.6a 13623
    ...
    SMSG_VOICESESSION_FULL                           = 0x0A456, // 4.0.6a 13623
    ...
    SMSG_IGNORE_DIMINISHING_RETURNS_CHEAT            = 0x0747E, // 4.0.6a 13623
    CMSG_KEEP_ALIVE                                  = 0x02CE0, // 4.0.6a 13623
    SMSG_RAID_READY_CHECK_ERROR                      = 0x0547E, // 4.0.6a 13623
    ...
    SMSG_SPLINE_MOVE_SET_FLYING                      = 0x05D54, // 4.0.6a 13623
    ...
    CMSG_CALENDAR_EVENT_INVITE_NOTES                 = 0x0045F, // 4.0.6a 13623
    SMSG_CALENDAR_EVENT_INVITE_NOTES                 = 0x00460, // 4.0.6a 13623
    SMSG_CALENDAR_EVENT_INVITE_NOTES_ALERT           = 0x00461, // 4.0.6a 13623
    ...
    CMSG_UPDATE_MISSILE_TRAJECTORY                   = 0x00E54, // 4.0.6a 13623
    ...
    SMSG_CALENDAR_RAID_LOCKOUT_UPDATED               = 0x00471, // 4.0.6a 13623
    CMSG_UNITANIMTIER_CHEAT                          = 0x101DE, // Unknown opcode ID
    CMSG_CHARACTER_CUSTOMIZE                              = 0x06484, // 4.0.6a 13623
    SMSG_CHARACTER_CUSTOMIZE                              = 0x02DA4, // 4.0.6a 13623
    ...
    CMSG_PET_UNLEARN_TALENTS                         = 0x08F5D, // 4.0.6a 13623
    ...
    SMSG_HIGHEST_THREAT_UPDATE                       = 0x03F7E, // 4.0.6a 13623
    ...
    CMSG_UPDATE_PROJECTILE_POSITION                  = 0x0EF7F, // 4.0.6a 13623
    ...
    CMSG_CHARACTER_FACTION_CHANGE                         = 0x0BBCC, // 4.0.6a 13623
    SMSG_CHARACTER_FACTION_CHANGE                         = 0x023AC, // 4.0.6a 13623
    ...
    CMSG_CHARACTER_RACE_CHANGE                            = 0x06EA4, // 4.0.6a 13623
    ...
    CMSG_TRANSFORM                                   = 0x04577, // 4.0.6a 13623
    ...
    SMSG_COMPLETED_ARTIFACTS                         = 0x0044E, // 4.0.6a 13623
    ...
    SMSG_UNKNOWN_GOLD                                = 0x0004E, // 4.0.6a 13623
    SMSG_REQUEST_WAR_GAME_RESPONSE                   = 0x00C1C, // 4.0.6a 13623
    SMSG_SERVER_MESSAGE_BOX                          = 0x0080C, // 4.0.6a 13623
    SMSG_TALENT_ERROR                                = 0x068A4, // 4.0.6a 13623
    SMSG_SEND_ERROR_MESSAGE                          = 0x0480C, // 4.0.6a 13623
    ...
    SMSG_UNKNOWN_1240                                = 0x0B8E0, // Unknown opcode Name
    SMSG_UNKNOWN_1308                                = 0x10011, // Unknown opcode Name, ID
    SMSG_UNKNOWN_1302                                = 0x10010, // Unknown opcode Name, ID
    CMSG_UNKNOWN_1303                                = 0x06BE0, // Unknown opcode Name
    SMSG_UNKNOWN_1304                                = 0x072E0, // Unknown opcode Name
    SMSG_UNKNOWN_1310                                = 0x02E88, // Unknown opcode Name
    SMSG_UNKNOWN_1311                                = 0x01E76, // Unknown opcode Name
    SMSG_UNKNOWN_1312                                = 0x04D56, // Unknown opcode Name
    ...
    SMSG_UNKNOWN_1329                                = 0x02D57, // Unknown opcode Name
    SMSG_UNKNOWN_1330                                = 0x0618C, // Unknown opcode Name
