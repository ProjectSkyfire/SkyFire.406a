...
enum CharacterDatabaseStatements
{
    ...
    */
    ...
    CHAR_SEL_CHARACTER_ACCOUNT_DATA,
    CHAR_UPD_PLAYER_ACCOUNT_DATA,
    ...
    // Currency
    CHAR_SEL_CHARACTER_CURRENCY,
    CHAR_SEL_CHARACTER_CP_WEEK_CAP, // conquest points
    CHAR_SEL_CP_VAL,
    ...
    CHAR_SEL_CHARACTER_ARENA_TEAMS,
    ...
    CHAR_REP_GO_RESPAWNS,
    CHAR_DEL_GO_RESPAWNS,
    CHAR_DEL_GO_RESPAWNS_BY_INSTANCE,
